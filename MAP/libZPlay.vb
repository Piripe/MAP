...
Private Structure TWaveInInfo_Internal
        ...
        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_CreateZPlay", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        Private Shared Function zplay_CreateZPlay() As UInteger
        End Function

        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_DestroyZPlay", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        Private Shared Function zplay_DestroyZPlay(ByVal objptr As UInteger) As Integer
        End Function

        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_SetSettings", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        ...
        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_GetSettings", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        Private Shared Function zplay_GetSettings(ByVal objptr As UInteger, ByVal nSettingID As Integer) As Integer
        End Function


        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_GetError", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        Private Shared Function zplay_GetError(ByVal objptr As UInteger) As IntPtr
        End Function

        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_GetErrorW", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Unicode, SetLastError:=True)>
        Private Shared Function zplay_GetErrorW(ByVal objptr As UInteger) As IntPtr
        End Function

        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_GetVersion", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        Private Shared Function zplay_GetVersion(ByVal objptr As UInteger) As Integer
        End Function

        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_GetFileFormat", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        ...
        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_GetFileFormatW", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Unicode, SetLastError:=True)>
        ...
        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_OpenFile", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        ...
        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_AddFile", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        ...
        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_OpenFileW", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Unicode, SetLastError:=True)>
        ...
        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_AddFileW", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Unicode, SetLastError:=True)>
        ...
        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_OpenStream", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        ...
        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_PushDataToStream", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        ...
        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_Close", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        Private Shared Function zplay_Close(ByVal objptr As UInteger) As Integer
        End Function

        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_Play", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        Private Shared Function zplay_Play(ByVal objptr As UInteger) As Integer
        End Function

        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_Stop", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        Private Shared Function zplay_Stop(ByVal objptr As UInteger) As Integer
        End Function

        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_Pause", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        Private Shared Function zplay_Pause(ByVal objptr As UInteger) As Integer
        End Function

        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_Resume", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        Private Shared Function zplay_Resume(ByVal objptr As UInteger) As Integer
        End Function

        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_IsStreamDataFree", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        Private Shared Function zplay_IsStreamDataFree(ByVal objptr As UInteger, <[In]()> ByVal sMemNewData() As Byte) As Integer
        End Function

        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_GetDynamicStreamLoad", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        Private Shared Sub zplay_GetDynamicStreamLoad(ByVal objptr As UInteger, ByRef pStreamLoadInfo As TStreamLoadInfo)
        End Sub

        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_GetPosition", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        Private Shared Sub zplay_GetPosition(ByVal objptr As UInteger, ByRef pTime As TStreamTime)
        End Sub

        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_PlayLoop", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        ...
        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_Seek", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        ...
        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_ReverseMode", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        Private Shared Function zplay_ReverseMode(ByVal objptr As UInteger, ByVal fEnable As Integer) As Integer
        End Function

        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_SetMasterVolume", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        ...
        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_SetPlayerVolume", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        ...
        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_GetMasterVolume", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        ...
        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_GetPlayerVolume", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        ...
        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_GetBitrate", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        Private Shared Function zplay_GetBitrate(ByVal objptr As UInteger, ByVal fAverage As Integer) As Integer
        End Function

        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_GetStatus", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        Private Shared Sub zplay_GetStatus(ByVal objptr As UInteger, ByRef pStatus As TStreamStatus)
        End Sub

        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_MixChannels", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        ...
        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_GetVUData", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        ...
        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_SlideVolume", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        ...
        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_EnableEqualizer", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        Private Shared Function zplay_EnableEqualizer(ByVal objptr As UInteger, ByVal fEnable As Integer) As Integer
        End Function

        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_SetEqualizerPoints", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        ...
        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_GetEqualizerPoints", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        ...
        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_SetEqualizerParam", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        ...
        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_GetEqualizerParam", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        ...
        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_SetEqualizerPreampGain", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        Private Shared Function zplay_SetEqualizerPreampGain(ByVal objptr As UInteger, ByVal nGain As Integer) As Integer
        End Function

        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_GetEqualizerPreampGain", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        Private Shared Function zplay_GetEqualizerPreampGain(ByVal objptr As UInteger) As Integer
        End Function

        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_SetEqualizerBandGain", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        ...
        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_GetEqualizerBandGain", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        Private Shared Function zplay_GetEqualizerBandGain(ByVal objptr As UInteger, ByVal nBandIndex As Integer) As Integer
        End Function

        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_EnableEcho", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        Private Shared Function zplay_EnableEcho(ByVal objptr As UInteger, ByVal fEnable As Integer) As Integer
        End Function

        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_StereoCut", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        ...
        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_SetEchoParam", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        ...
        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_GetEchoParam", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        ...
        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_GetFFTData", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        ...
        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_SetRate", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        Private Shared Function zplay_SetRate(ByVal objptr As UInteger, ByVal nRate As Integer) As Integer
        End Function

        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_GetRate", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        Private Shared Function zplay_GetRate(ByVal objptr As UInteger) As Integer
        End Function

        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_SetPitch", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        Private Shared Function zplay_SetPitch(ByVal objptr As UInteger, ByVal nPitch As Integer) As Integer
        End Function

        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_GetPitch", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        Private Shared Function zplay_GetPitch(ByVal objptr As UInteger) As Integer
        End Function

        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_SetTempo", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        Private Shared Function zplay_SetTempo(ByVal objptr As UInteger, ByVal nTempo As Integer) As Integer
        End Function

        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_GetTempo", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        Private Shared Function zplay_GetTempo(ByVal objptr As UInteger) As Integer
        End Function

        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_DrawFFTGraphOnHDC", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        ...
        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_DrawFFTGraphOnHWND", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        ...
        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_SetFFTGraphParam", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        ...
        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_GetFFTGraphParam", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        Private Shared Function zplay_GetFFTGraphParam(ByVal objptr As UInteger, ByVal nParamID As Integer) As Integer
        End Function


        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_LoadID3W", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        ...
        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_LoadFileID3W", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Unicode, SetLastError:=True)>
        ...
        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_DetectBPM", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        Private Shared Function zplay_DetectBPM(ByVal objptr As UInteger, ByVal nMethod As UInteger) As Integer
        End Function

        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_DetectFileBPM", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        ...
        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_DetectFileBPMW", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Unicode, SetLastError:=True)>
        ...
        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_SetCallbackFunc", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        ...
        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_EnumerateWaveIn", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        Private Shared Function zplay_EnumerateWaveIn(ByVal objptr As UInteger) As Integer
        End Function

        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_GetWaveInInfoW", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        ...
        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_SetWaveInDevice", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        Private Shared Function zplay_SetWaveInDevice(ByVal objptr As UInteger, ByVal nIndex As UInteger) As Integer
        End Function


        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_EnumerateWaveOut", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        Private Shared Function zplay_EnumerateWaveOut(ByVal objptr As UInteger) As Integer
        End Function

        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_GetWaveOutInfoW", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Unicode, SetLastError:=True)>
        ...
        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_SetWaveOutDevice", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Ansi, SetLastError:=True)>
        Private Shared Function zplay_SetWaveOutDevice(ByVal objptr As UInteger, ByVal nIndex As UInteger) As Integer
        End Function


        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_GetStreamInfoW", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Unicode, SetLastError:=True)>
        Private Shared Function zplay_GetStreamInfoW(ByVal objptr As UInteger, ByRef pInfo As TStreamInfo_Internal) As Integer
        End Function


        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_LoadID3ExW", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Unicode, SetLastError:=True)>
        ...
        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_LoadFileID3ExW", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Unicode, SetLastError:=True)>
        ...
        <System.Runtime.InteropServices.DllImport("lib/libzplay.dll", EntryPoint:="zplay_SetWaveOutFileW", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Unicode, SetLastError:=True)>
