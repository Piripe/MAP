...
Public Class DefaultOverlay
	...
	Public Sub New(Name As String)
		...
		If flag Then
			Me.m_layeredWnd = New AlphaForms.LayeredWindow(Name)
		End If
		Me.m_sizeMode = SizeModes.None
	...
	Public Sub SetOpacity(Opacity As Double)
		...
		If flag Then
			...
			Dim flag2 As Boolean = Me.m_sizeMode = SizeModes.None
			If flag2 Then
		...
		If Not flag Then
			...
			If flag2 Then
				...
				If flag4 Then
					...
					Me.m_backgroundFull = Nothing
				End If
				Dim flag5 As Boolean = Me.m_sizeMode = SizeModes.Clip
				If flag5 Then
	...
	Friend m_layeredWnd As AlphaForms.LayeredWindow
	...
	Private m_isDown As HeldButtons
	...
	Protected Overrides ReadOnly Property CreateParams() As CreateParams
		Get
			...
			cp.ExStyle = cp.ExStyle Or &H80000 Or &H80
			Return cp

		End Get
	End Property

	Private Sub DefaultOverlay_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
